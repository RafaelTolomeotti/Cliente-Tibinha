-- CONFIG
APP_NAME = "Tibinha"  -- important, change it, it's name for config dir and files in appdata
...
Services = {
  website = "http://www.tibinha.online", -- currently not used
  updater = "http://181.214.221.86/files/updater_advanced.php",
  stats = "",
  crash = "",
  feedback = "",
  status = "https://server.tibiarpgbrasil.com/otcv8/api/status.php"
}

-- Servers accept http login url, websocket login url or ip:port:version
Servers = {
 Tibinha = "tibinha.online:7171:772",
